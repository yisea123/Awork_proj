...
#include "aw_int.h"
#include "driver/timer/awbl_imx1050_pit.h"

/** \brief PIT 设备信息 */
aw_local aw_const awbl_imx1050_pit_devinfo_t __g_imx1050_pit_devinfo = {
    1,                              /* 通过名称分配定时器 */
...
/** \brief 设备实例内存静态分配 */
aw_local struct awbl_imx1050_pit_dev __g_imx1050_pit_dev;

#define AWBL_HWCONF_IMX1050_PIT     \
    {                               \
        AWBL_IMX1050_PIT_DRV_NAME,  \
        IMX1050_PIT_BUSID,          \
        AWBL_BUSID_PLB,             \
        0,                          \
