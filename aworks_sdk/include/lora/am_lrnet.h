 ...
 * @{
 */
#define AM_LRNET_ADDR_CENTER                 0x0000  /**< \brief address of center */
#define AM_LRNET_ADDR_ROUTER_LOWEST          0x0001  /**< \brief lowest address of router */
#define AM_LRNET_ADDR_ROUTER_HIGHEST         0x007F  /**< \brief highest address of router */
#define AM_LRNET_ADDR_INVALID                0x00FF  /**< \brief invalid address of router */
#define AM_LRNET_ADDR_TERMINAL_LOWEST        0x0100  /**< \brief lowest address of terminal */
#define AM_LRNET_ADDR_TERMINAL_HIGHEST       0x06FF  /**< \brief highest address of terminal */
#define AM_LRNET_ADDR_GROUP_CAST_LOWEST      0xFF00  /**< \brief lowest address of group cast */
#define AM_LRNET_ADDR_GROUP_CAST_HIGHEST     0xFFFE  /**< \brief highest address of group cast */
#define AM_LRNET_ADDR_BROADCAST              0xFFFF  /**< \brief broadcast address */
...
typedef struct am_lrnet_rf_cfg {
    uint32_t           data_channel;  /**< \brief LoRa RF Data Channel Frequency */
