...
#define __GPT1_FOR_TIMER     /**< \brief 配置 GPT 为定时器模式 */
//#define __GPT1_FOR_INPUT     /**< \brief 配置 GPT 为输入捕获模式 */
//#define __GPT1_FOR_OUTPUT    /**< \brief 配置 GPT 为输出比较模式 */
...
aw_local aw_const awbl_imx1050_gpt_devinfo_t __g_imx1050_gpt1_param = {
    ...
    0,                              /* 不使用输入输出通道 */
    0,                              /* 无输出比较值 */
    __imx1050_gpt1_plfm_init        /* 平台初始化函数 */
};
/* __GPT_FOR_TIMER */
