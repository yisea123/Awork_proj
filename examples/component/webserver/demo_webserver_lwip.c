...
/**
 * \addtogroup demo_if_webserver_lwip
...
aw_local void __webserver_task_entry(void){
...
void demo_web_server_entry (void){
    ...
    // 定义任务实体 my_task
    AW_TASK_DECL_STATIC(webserver_task, 512);
