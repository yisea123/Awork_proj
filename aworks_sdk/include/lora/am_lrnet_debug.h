 ...
 *            Set AM_LRNET_SRCFG_DEBUG_INFO_LV to conceal the lower level debug info.
 *            Set AM_LRNET_SRCFG_DEBUG_INFO_LV_MASK to conceal the specified level info.
 *
 *              Level       Description
 *              --------------------------
...
#if AM_LRNET_SRCFG_DEBUG
#define AM_LRNET_SRCFG_DEBUG_INFO_LV   0           /* SDK User Debug Level */
#else
...
#if (AM_LRNET_SRCFG_DEBUG && (AM_LRNET_SRCFG_DEBUG_INFO_LV <= 0) && (AM_LRNET_SRCFG_DEBUG_INFO_LV_MASK & (1 << 0)))
#define AM_LRNET_DEBUG_INFO_L0   __DEBUG_PRINTF
#else
__UNUSED_MACRO_PRINTF(AM_LRNET_DEBUG_INFO_L0)
#endif

#if (AM_LRNET_SRCFG_DEBUG && (AM_LRNET_SRCFG_DEBUG_INFO_LV <= 1) && (AM_LRNET_SRCFG_DEBUG_INFO_LV_MASK & (1 << 1)))
#define AM_LRNET_DEBUG_INFO_L1   __DEBUG_PRINTF
#else
__UNUSED_MACRO_PRINTF(AM_LRNET_DEBUG_INFO_L1)
#endif

#if (AM_LRNET_SRCFG_DEBUG && (AM_LRNET_SRCFG_DEBUG_INFO_LV <= 2) && (AM_LRNET_SRCFG_DEBUG_INFO_LV_MASK & (1 << 2)))
#define AM_LRNET_DEBUG_INFO_L2   __DEBUG_PRINTF
#else
__UNUSED_MACRO_PRINTF(AM_LRNET_DEBUG_INFO_L2)
#endif

#if (AM_LRNET_SRCFG_DEBUG && (AM_LRNET_SRCFG_DEBUG_INFO_LV <= 3) && (AM_LRNET_SRCFG_DEBUG_INFO_LV_MASK & (1 << 3)))
#define AM_LRNET_DEBUG_INFO_L3   __DEBUG_PRINTF
#else
__UNUSED_MACRO_PRINTF(AM_LRNET_DEBUG_INFO_L3)
#endif

#if (AM_LRNET_SRCFG_DEBUG && (AM_LRNET_SRCFG_DEBUG_INFO_LV <= 4) && (AM_LRNET_SRCFG_DEBUG_INFO_LV_MASK & (1 << 4)))
#define AM_LRNET_DEBUG_INFO_L4   __DEBUG_PRINTF
#else
__UNUSED_MACRO_PRINTF(AM_LRNET_DEBUG_INFO_L4)
#endif

#if (AM_LRNET_SRCFG_DEBUG && (AM_LRNET_SRCFG_DEBUG_INFO_LV <= 5) && (AM_LRNET_SRCFG_DEBUG_INFO_LV_MASK & (1 << 5)))
#define AM_LRNET_DEBUG_INFO_L5   __DEBUG_PRINTF
#else
__UNUSED_MACRO_PRINTF(AM_LRNET_DEBUG_INFO_L5)
#endif

#if (AM_LRNET_SRCFG_DEBUG && (AM_LRNET_SRCFG_DEBUG_INFO_LV <= 6) && (AM_LRNET_SRCFG_DEBUG_INFO_LV_MASK & (1 << 6)))
#define AM_LRNET_DEBUG_INFO_L6   __DEBUG_PRINTF
#else
__UNUSED_MACRO_PRINTF(AM_LRNET_DEBUG_INFO_L6)
#endif

#if (AM_LRNET_SRCFG_DEBUG && (AM_LRNET_SRCFG_DEBUG_INFO_LV <= 7) && (AM_LRNET_SRCFG_DEBUG_INFO_LV_MASK & (1 << 7)))
...
#define __ASSERT_VTOS(n)     #n                 /**< \brief Convert n to string */
#define __ASSERT_SVAL(m)     __ASSERT_VTOS(m)   /**< \brief Get string value of macro m */
