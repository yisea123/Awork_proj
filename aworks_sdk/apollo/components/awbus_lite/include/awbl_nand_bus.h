...
//    struct awbl_drvinfo awdrv;
    ...
    /** \brief Nand芯片就绪检查 */
    bool_t (*pfn_ready) (struct awbl_nandbus        *p_bus,
                         void                       *p_chip);
 ...
 * \return AW_OK表示操作成功，其他表示失败。
 */
aw_err_t awbl_nandbus_select (struct awbl_nandbus *p_bus, void   *p_chip);
 ...
 * \return AW_OK表示操作成功，其他表示失败。
 */
bool_t awbl_nandbus_is_ready (struct awbl_nandbus *p_bus);
