...
/**
 * \file
 * \brief Freescale i.MXRT1050 eFlexPWM外设驱动
 *
 * \internal
...
#ifndef __AWBL_IMX1050_EFLEX_PWM_H
#define __AWBL_IMX1050_EFLEX_PWM_H
...
#define AWBL_IMX1050_EFLEX_PWM_NAME      "imx1050_eflex_pwm"
...
/**
 * \brief iMX RT1050 eFlexPWM 设备配置
 */
typedef struct awbl_imx1050_eflex_pwm_devcfg {
...
} awbl_imx1050_eflex_pwm_devcfg_t;

/**
 * \brief iMX RT1050 eFlexPWM 设备信息
 */
typedef struct awbl_imx1050_eflex_pwm_devinfo {
    ...
    /** \brief PWM配置信息 */
    aw_const struct awbl_imx1050_eflex_pwm_devcfg *pwm_devcfg;
    uint8_t                  pnum;               /**< \brief 使用到的PWM通道数*/

    /** \brief 平台相关初始化：开启时钟、初始化引脚等操作 */
    void (*pfunc_plfm_init)(void);

} awbl_imx1050_eflex_pwm_devinfo_t;


/**
 * \brief iMX RT1050 eFlexPWM 设备实例
 */
typedef struct awbl_imx1050_eflex_pwm_dev {
...
} awbl_imx1050_eflex_pwm_dev_t;


/**
 * \brief iMX RT1050 eFlexPWM driver register
 */
void awbl_imx1050_eflex_pwm_drv_register (void);
...
#endif /* __AWBL_IMX1050_EFLEX_PWM_H */
