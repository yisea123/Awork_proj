...
/* Mode page codes for mode sense/set 下面的命令表请参考ssf-8020i */
...
#define AWBL_CDROM_MINS              74 /* max. minutes per CD, not really a limit */
#define AWBL_CDROM_SECS              60 /* seconds per minute */
#define AWBL_CDROM_FRAMES            75 /* frames per second */
#define AWBL_CDROM_SYNC_SIZE         12 /* 12 sync bytes per raw data frame */
#define AWBL_CDROM_MSF_OFFSET       150 /* MSF numbering offset of first frame */
#define AWBL_CDROM_CHUNK_SIZE        24 /* lowest-level "data bytes piece" */
#define AWBL_CDROM_NUM_OF_CHUNKS     98 /* chunks per frame */
#define AWBL_CDROM_FRAMESIZE_SUB     96 /* subchannel data "frame" size */
#define AWBL_CDROM_HEAD_SIZE          4 /* header (address) bytes per raw data frame */
#define AWBL_CDROM_SUBHEAD_SIZE       8 /* subheader bytes per raw XA data frame */
#define AWBL_CDROM_EDC_SIZE           4 /* bytes EDC per most raw data frame types */
#define AWBL_CDROM_ZERO_SIZE          8 /* bytes zero per yellow book mode 1 frame */
#define AWBL_CDROM_ECC_SIZE         276 /* bytes ECC per most raw data frame types */
#define AWBL_CDROM_FRAMESIZE       2048 /* bytes per frame, "cooked" mode */
#define AWBL_CDROM_FRAMESIZE_RAW   2352 /* bytes per frame, "raw" mode */
#define AWBL_CDROM_FRAMESIZE_RAWER 2646 /* The maximum possible returned bytes */
/* most drives don't deliver everything: */
#define AWBL_CDROM_FRAMESIZE_RAW1 \
    (AWBL_CDROM_FRAMESIZE_RAW - AWBL_CDROM_SYNC_SIZE)                        /*2340*/
#define AWBL_CDROM_FRAMESIZE_RAW0 \
    (AWBL_CDROM_FRAMESIZE_RAW - AWBL_CDROM_SYNC_SIZE - AWBL_CDROM_HEAD_SIZE) /*2336*/

#define AWBL_CDROM_XA_HEAD      (AWBL_CDROM_HEAD_SIZE + AWBL_CDROM_SUBHEAD_SIZE) /* "before data" part of raw XA frame */
#define AWBL_CDROM_XA_TAIL      (AWBL_CDROM_EDC_SIZE  + AWBL_CDROM_ECC_SIZE)     /* "after data" part of raw XA frame */
#define AWBL_CDROM_XA_SYNC_HEAD (AWBL_CDROM_SYNC_SIZE + AWBL_CDROM_XA_HEAD)      /* sync bytes + header of XA frame */

/* Request Sense Standard Data and bit define */
