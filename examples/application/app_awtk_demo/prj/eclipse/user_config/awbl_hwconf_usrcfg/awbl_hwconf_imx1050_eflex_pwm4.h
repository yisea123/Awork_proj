...
#include "driver/pwm/awbl_imx1050_eflex_pwm.h"
...
aw_local aw_const awbl_imx1050_eflex_pwm_devcfg_t __g_imx1050_eflex_pwm4_devcfg_list[] = {
...
aw_local awbl_imx1050_eflex_pwm_devinfo_t __g_imx1050_eflex_pwm4_devinfo = {
...
/* 设备实例内存静态分配 */
aw_local awbl_imx1050_eflex_pwm_dev_t __g_imx1050_eflex_pwm4;

#define AWBL_HWCONF_IMX1050_EFLEX_PWM4      \
    {                                       \
       AWBL_IMX1050_EFLEX_PWM_NAME,         \
        0,                                  \
        AWBL_BUSID_PLB,                     \
        0,                                  \
