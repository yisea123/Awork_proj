 ...
 * \name grp_tps02r_chan
 */
#define AW_TPS02R_CHAN_1      0    /* TPS02R 的通道1 */
#define AW_TPS02R_CHAN_2      1    /* TPS02R 的通道2 */
...
typedef struct awbl_tps02r_devinfo {
     ...
     *  \brief 该传感器通道的起始id
     *
     *  TPS02R 共有2路温度采集通道，从start_id开始(包括start_id)连续两个ID分配给该模块的两个通道，
     *  其中 start_id 对应模块的通道1 ，  start_id + 1 对应模块的 通道 2
     *  eg： 将start_id 配置为  0 , 则 ID = 0 对应模块的通道1， ID = 1，对应模块的通道 2.
     */
    int     start_id;
