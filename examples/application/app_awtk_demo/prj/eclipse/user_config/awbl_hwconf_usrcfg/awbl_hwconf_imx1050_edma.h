...
#include "driver/edma/awbl_imx1050_edma.h"
...
/* 设备信息 */
aw_local aw_const struct awbl_imx1050_edma_devinfo __g_imx1050_edma_devinfo = {
    IMX1050_EDMA_BASE,
    IMX1050_DMAMUX_BASE,
    inum,
...
/* 设备实例内存静态分配 */
aw_local awbl_imx1050_edma_dev_t __g_imx1050_edma_dev = {{0}};

#define AWBL_HWCONF_IMX1050_EDMA     \
    {                               \
        AWBL_IMX1050_EDMA_NAME,      \
        0,                          \
        AWBL_BUSID_PLB,             \
        0,                          \
