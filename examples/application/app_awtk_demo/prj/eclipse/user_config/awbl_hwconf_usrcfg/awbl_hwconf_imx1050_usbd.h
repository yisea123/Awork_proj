...
#include "driver/usb/awbl_imx1050_usbd.h"
...
aw_local void __imx1050_usbd_pwr_ctrl (bool_t on)
{
    if (on) {
...
/* 设备实例内存静态分配 */
static struct awbl_imx1050_usbd __g_imx1050_usbd_dev;

#define AWBL_HWCONF_IMX1050_USBD                   \
    {                                              \
        AWBL_IMX1050_USBD_DRV_NAME,                \
        0,                                         \
        AWBL_BUSID_PLB,                            \
        0,                                         \
