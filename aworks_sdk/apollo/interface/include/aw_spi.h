...
#define AW_SPI_CPHA         0x01  /**< \brief 时钟相位可设置 */
#define AW_SPI_CPOL         0x02  /**< \brief 时钟极性可设置*/
#define AW_SPI_CS_HIGH      0x04  /**< \brief 片选高有效 */
...
#define AW_SPI_READY        0x80  /**< \brief READY信号,从机拉低此信号暂停传输 */
#define AW_SPI_AUTO_CS      0x100 /**< \brief 硬件自动控制 CS 输出 */

#define AW_SPI_MODE_0   (0 | 0)             /**< \brief 支持SPI模式0 (MicroWire) */
#define AW_SPI_MODE_1   (0 | AW_SPI_CPHA)   /**< \brief 支持SPI模式1 */
#define AW_SPI_MODE_2   (AW_SPI_CPOL | 0)   /**< \brief 支持SPI模式2 */
#define AW_SPI_MODE_3   (AW_SPI_CPOL | AW_SPI_CPHA) /**< \brief 支持SPI模式3 */

#define AW_SPI_READ_MOSI_HIGH    0x01 /**< \brief SPI在读取过程中MOSI引脚输出高电平（默认为低电平）*/
