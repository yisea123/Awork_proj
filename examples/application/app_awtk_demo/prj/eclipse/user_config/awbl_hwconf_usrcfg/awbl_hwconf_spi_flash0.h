...
aw_local aw_const struct awbl_nvram_segment __g_snvram_seglst0[] = {
    /* 存储段名称, 单元号, 起始地址，长度 */
    {"wifi_firmware", 0, 0, 1024 * 256}, // wifi firmware
    {"spi_flash0_nvram",  0, 0, 8*1024*1024},
    {"spi_flash0_nvram0", 0, 1*1024*1024, 4096},
    {"spi_flash0_nvram1", 0, 2*1024*1024, 4096},
    {"spi_flash0_nvram2", 0, 3*1024*1024, 4096},
};
...
aw_local aw_const struct awbl_spi_flash_mtd_info __g_fmtd_info0  = {
        512,   /* start block for MTD */
        512    /* number of blocks for MTD */
};
