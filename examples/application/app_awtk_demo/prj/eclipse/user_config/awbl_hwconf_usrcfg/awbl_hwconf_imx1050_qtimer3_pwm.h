...
#include "driver/pwm/awbl_imx1050_qtimer_pwm.h"
...
aw_local aw_const awbl_imx1050_qtimer_pwm_devcfg_t __g_imx1050_qtimer3_pwm_devcfg_list[] = {
...
aw_local awbl_imx1050_qtimer_pwm_devinfo_t __g_imx1050_qtimer3_pwm_devinfo = {
...
/* 设备实例内存静态分配 */
aw_local awbl_imx1050_qtimer_pwm_dev_t __g_imx1050_qtimer3_pwm;

#define AWBL_HWCONF_IMX1050_QTIMER3_PWM      \
    {                                        \
       AWBL_IMX1050_QTIMER_PWM_NAME,         \
        0,                                   \
        AWBL_BUSID_PLB,                      \
        0,                                   \
