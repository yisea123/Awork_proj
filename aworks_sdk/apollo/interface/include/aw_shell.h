 ...
 * @internal
 * @par History
 * - 170619, vih, 增加命令集；增加tab补全;
 * - 160107, deo, remove aw_fs_state_t
...
typedef struct aw_shell_opt {
    ...
    bool_t       use_escape_seq;        /**< \brief 使用转义序列 */
    bool_t       use_history;           /**< \brief 使用历史功能 */
    bool_t       use_color;             /**< \brief 使用颜色 */
    bool_t       use_complete;          /**< \brief 使用补全 */
    bool_t       use_cursor;            /**< \brief 使用光标 */
    bool_t       use_cmdset;            /**< \brief 使用命令集 */
    bool_t       use_chart;             /**< \brief 使用表格 */
