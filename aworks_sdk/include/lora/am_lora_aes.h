...
return_type am_lora_aes_encrypt (const uint8_t               in[AM_LORA_AES_N_BLOCK],
                                 uint8_t                     out[AM_LORA_AES_N_BLOCK],
                                 const am_lora_aes_context_t ctx[1]);

return_type am_lora_aes_cbc_encrypt (const uint8_t              *p_in,
                                     uint8_t                    *p_out,
                                     int32_t                     n_block,
...
return_type am_lora_aes_decrypt (const uint8_t               in[AM_LORA_AES_N_BLOCK],
                                 uint8_t                     out[AM_LORA_AES_N_BLOCK],
                                 const am_lora_aes_context_t ctx[1]);

return_type am_lora_aes_cbc_decrypt (const uint8_t              *p_in,
                                     uint8_t                    *p_out,
                                     int32_t                     n_block,
                                     uint8_t                     iv[AM_LORA_AES_N_BLOCK],
                                     const am_lora_aes_context_t ctx[1]);
