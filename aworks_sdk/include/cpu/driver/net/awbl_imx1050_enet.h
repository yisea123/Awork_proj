...
/**
 * \file
 * \brief AWBus-lite iMX RT1050 ENET 驱动
 *
 * \internal
...
#ifndef __AWBL_IMX1050_ENET_H
#define __AWBL_IMX1050_ENET_H
...
#include "driver/net/imx1050_enet_regs.h"
...
/** \brief iMX RT1050 ENET 驱动名称 */
#define AWBL_IMX1050_ENET_NAME       "awbl_imx1050_enet"
#define AWBL_IMX1050_ENET_RX_THREAD_STK_SIZE    2048
...
/** \brief iMX RT1050 ENET 设备信息 */
struct awbl_imx1050_enet_devinfo {
    ...
    int                         phy_use_mii_bus_id;     /**< \brief 此EMAC链接的PHY使用的MII bus编号 */
...
/** \brief iMX RT1050 enet 设备 */
typedef struct awbl_imx1050_enet_dev {
    struct awbl_dev         dev;                /**< \brief 平台相关初始化函数 */
    aw_netif_t              ethif;              /**< \brief 对应LWIP 以太网接口 */
    struct awbl_mii_master  mii_master;         /**< \brief mii总线 */
    struct awbl_dev        *p_emac_mii_dev;     /**< \brief 实际使用的mii总线设备 */

    AW_SEMB_DECL(mii_sem);                      /**< \brief 标志MII操作完成的信号量 */
    AW_MUTEX_DECL(mii_lock);                    /**< \brief 同步MII操作的互斥锁 */
    awbl_miibus_read_t      fn_mii_bus_read;    /**< \brief 指向MII总线读的函数 */
    awbl_miibus_write_t     fn_mii_bus_write;   /**< \brief 指向MII总线写的函数 */
    ...
    AW_TASK_DECL(rx_task, AWBL_IMX1050_ENET_RX_THREAD_STK_SIZE);
    AW_SEMB_DECL(rx_semb);
} awbl_imx1050_enet_dev_t;

void awbl_imx1050_enet_drv_register (void);

#ifdef __cplusplus
}
#endif  /* __cplusplus  */

#endif  /* __AWBL_IMX1050_ENET_H */
