 ...
 */
static bool_t label_set_random_double(widget_t* label, double min_num, double max_num, double alarm) {
  if (label) {
    char text[64];
...
static ret_t on_reading_update(const timer_info_t* timer) {
  ...
  if (label_set_random_double(temperature_in1, 22.5, 24.8, 24.0)) {
    widget_use_style(temperature_in1, "reading_temp_hum_alarm");
    alarm = TRUE;
  } else {
    widget_use_style(temperature_in1, "reading_temp_hum");
  }

  if (label_set_random_double(temperature_in2, 22.5, 24.8, 24.0)) {
    widget_use_style(temperature_in2, "reading_temp_hum_alarm");
    alarm = TRUE;
  } else {
    widget_use_style(temperature_in2, "reading_temp_hum");
  }
  ...
  if (label_set_random_double(temperature_out1, 20.5, 22.8, 22.0)) {
    ...
    widget_use_style(temperature_out1, "reading_temp_hum");
  }
  ...
  if (label_set_random_double(temperature_out2, 20.5, 22.8, 22.0)) {
    ...
    widget_use_style(temperature_out2, "reading_temp_hum");
  }
