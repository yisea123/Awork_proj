...
struct awbl_hc595_led_dev {
    ...
    aw_err_t (*pfn_hc595_led_set)(struct awbl_hc595_led_dev *p_this, int id, bool_t on);
 ...
 */
aw_local aw_inline aw_err_t awbl_hc595_led_set (struct awbl_hc595_led_dev *p_this, int id, bool_t on)
{
	return p_this->pfn_hc595_led_set (p_this, id, on);
}

aw_local aw_inline void awbl_hc595_led_data_send (struct awbl_hc595_led_dev *p_this,
		                                          uint8_t                    scan_index,
		                                          uint8_t                    led_rank_idx)
{
