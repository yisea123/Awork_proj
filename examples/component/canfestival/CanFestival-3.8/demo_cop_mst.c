...
#define __COP_MST_MST_NODE_ID   127  /* 主机ID */
#define __COP_MST_SLV_NODE_ID   1    /* 从机ID */

#define __COP_MST_SYNC_ID       0X80 /* 同步报文ID */
...
static UNS8 __cop_mst_tpdo_set (UNS32 cobId, UNS16 index)
{
    ...
    res = sendPDOevent(&aworkstest_Data);
//    res = sendOnePDOevent(&aworkstest_Data, 1);
//    if (res == 1) {
//        res = 0;
//    } else {
//        res = 1;
//    }
//    res = sendPDOrequest(&aworkstest_Data, 0x1400);
...
void demo_cop_mst (void)
{
    ...
    UNS32   rsize = sizeof(UNS32);

    UNS32   TPDO1_COBID = 0x0217;
    UNS32   TPDO2_COBID = 0x0317;
    UNS32   tsize = sizeof(UNS32);
    ...
    ret = writeLocalDict(&aworkstest_Data, /*CO_Data* d*/
                         0x1400, /*UNS16 index*/
                         0x01, /*UNS8 subind*/
                         &RPDO1_COBID, /*void * pSourceData,*/
                         &rsize, /* UNS32 * pExpectedSize*/
                         RW);  /* UNS8 checkAccess */
    ...
    ret = writeLocalDict(&aworkstest_Data,
                         0x1280,
                         1,
...
static void __cop_mst_pdo_tx_task_entry (void *p_arg)
{
    ...
    AW_FOREVER {
        ...
        writeLocalDict(&aworkstest_Data, /*CO_Data* d*/
                       0x2004, /* UNS16 index*/
                       0x00,   /* UNS8 subind*/
...
static void __cop_mst_pdo_rx_task_entry (void *p_arg)
{
    ...
    AW_FOREVER {
        ...
        data = 0;
        size = sizeof(uint32_t);
        readLocalDict(&aworkstest_Data, /*CO_Data* d*/
                      0x2000, /* UNS16 index*/
                      0x00,   /* UNS8 subind*/
                      &data,  /* void * pSourceData */
                      &size,  /* UNS8 * pExpectedSize*/
