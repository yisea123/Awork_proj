...
typedef enum u9300c_status {
    AWBL_GPRS_U9300C_RST_ON             = 0x00000001,               /**< \brief 模块启动复位 */
//    AWBL_GPRS_U9300C_GPRS_ON            = 0x00000001<<4,            /**< \brief gprs功能启动，使用内部协议栈 */
    AWBL_GPRS_U9300C_GPRS_PPP_OK        = 0x00000001<<3,            /**< \brief 内部协议栈的ppp开启  */
    AWBL_GPRS_U9300C_GPRS_PDP_OK        = 0x00000001<<5,            /**< \brief gprs的PDP设置完成  */
    AWBL_GPRS_U9300C_SIM_OK             = 0x00000001<<6,            /**< \brief SIM卡正常 （如果sim卡正常，信号正常，却发不出短信，则欠费） */
...
//    struct awbl_gprs_u9300c_dev     *p_next;           /**< \brief next device */
