...
//aw_local void __imx1050_usbh1_pwr_ctrl (bool_t on)
//{
//    if (on) {
...
/* 设备信息 */
aw_local aw_const struct awbl_imx1050_usbh_info  __g_imx1050_usbh1_info = {
        {IMX1050_USBH1_BUSID},
        1,
...
/* 设备实例内存静态分配 */
struct awbl_imx1050_usbh __g_imx1050_usbh1_dev;
