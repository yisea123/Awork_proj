 ...
 * - 141223 orz, remove block device pointer from mount info.
 * - 140815 orz, first implementation.
 * \endinternal
 */
...
#define AW_CFG_MOUNT_POINT_NAME_MAX 32 /**< <= 0 for infinite name length */
#endif

#ifndef AW_CFG_MOUNT_DEV_NAME_MAX
#define AW_CFG_MOUNT_DEV_NAME_MAX   32 /**< <= 0 for infinite name length */
#endif
...
int aw_mount_table_add (const char *mnt,
                        const char *dev,
                        const char *fs,
                        unsigned    flags);
