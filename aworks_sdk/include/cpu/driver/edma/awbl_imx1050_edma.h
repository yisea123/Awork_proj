...
/**
 * \file
 * \brief imx1050 eDMA driver header file
 *
...
#ifndef __AWBL_IMX1050_EDMA_H
#define __AWBL_IMX1050_EDMA_H

#include "aworks.h"
#include "driver/edma/aw_imx1050_edma.h"
#include "aw_sem.h"
#include "aw_task.h"
#include "driver/edma/awbl_imx1050_edma_service.h"
#include "driver/edma/imx1050_edma_regs.h"
...
typedef struct edma_engine {
    ...
    struct awbl_imx1050_edma_service edma_serv;

} awbl_imx1050_edma_dev_t;

/**
 * \brief imx1050 eDMA  设备信息
 */
typedef struct awbl_imx1050_edma_devinfo {
...
} awbl_imx1050_edma_devinfo_t;


void awbl_imx1050_edma_drv_register (void);
