 ...
 *      aw_ts_lock(bool_t lock)  — 触摸屏锁屏 (TRUE: 锁屏, FALSE: 解锁)
 *
 *
 * \internal
 ...
 * \param[in]  vendor   当前触摸服务关联显示屏的厂商id
 *
 * \param[in]  product  当前触摸服务关联显示屏的产品id
 *
 * \return 触摸服务的id
 *
 ...
 * \brief 触摸屏锁屏，禁止触摸
 * \param[in] ts_id: 触摸服务id
 * \param[in] lock : TRUE : 锁屏 / FALSE: 解锁
 *
 * \return 无
 */
void aw_ts_lock (aw_ts_id ts_id, bool_t lock);
