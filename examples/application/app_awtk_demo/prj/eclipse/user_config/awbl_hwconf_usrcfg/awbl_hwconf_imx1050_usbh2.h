...
#include "driver/usb/awbl_imx1050_usbh.h"
...
//aw_local void __imx1050_usbh2_pwr_ctrl (bool_t on)
//{
//    if (on) {
...
/* 设备信息 */
aw_local aw_const struct awbl_imx1050_usbh_info  __g_imx1050_usbh2_info = {
        {IMX1050_USBH2_BUSID},
        1,
...
/* 设备实例内存静态分配 */
aw_local struct awbl_imx1050_usbh __g_imx1050_usbh2_dev;

#define AWBL_HWCONF_IMX1050_USBH2                     \
    {                                                 \
        AWBL_IMX1050_USBH_DRV_NAME,                   \
        0,                                            \
        AWBL_BUSID_PLB,                               \
        0,                                            \
