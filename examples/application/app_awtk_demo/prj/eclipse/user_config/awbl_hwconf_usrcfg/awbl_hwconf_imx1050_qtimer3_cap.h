...
#include "driver/cap/awbl_imx1050_qtimer_cap.h"

#ifdef AW_DEV_IMX1050_QTIMER3_CAP


/* QTimer3 Capture 通道与引脚信息 */
aw_local aw_const awbl_imx1050_qtimer_cap_devcfg_t __g_imx1050_qtimer3_cap_devcfg_list[] = {
...
aw_local awbl_imx1050_qtimer_cap_devinfo_t __g_imx1050_qtimer3_cap_devinfo = {
...
aw_local struct awbl_imx1050_qtimer_cap_dev __g_imx1050_qtimer3_cap_dev;

#define AWBL_HWCONF_IMX1050_QTIMER_CAP   \
{                                        \
    AWBL_IMX1050_QTIMER_CAP_NAME,        \
    0,                                   \
    AWBL_BUSID_PLB,                      \
    0,                                   \
...
#else   /* AWBL_HWCONF_IMX1050_QTIMER_CAP */
