 ...
 *      用户可用一次键入“func3 -w 123 abc -d 456 edf -r 789”，此时shell终端会
                            ...
                            struct aw_shell_user *sh )
{
    ...
    while (1) {
        ...
        /* 如果参数形式是“-d [arg1] [arg2]”的形式 */
            ...
            aw_shell_printf(sh, "demo delete %d %s.\n", aw_shell_long_arg(sh, 1),
                                                     aw_shell_str_arg(sh, 2));
