...
/**
 * \addtogroup demo_if_can_simple_send
 * \copydoc demo_can_simple_send.c
 */
 ...
 * \return 无
 */
static void __can_simple_send_task (void *p_arg)
{
    aw_can_err_t        ret;
 ...
 * \return 无
 */
void demo_can_simple_send (void)
{
