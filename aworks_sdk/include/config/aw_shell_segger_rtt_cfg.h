...
#include "shell/aw_shell_segger_rtt.h"
...
#    define AW_CFG_SHELL_THREAD_STK_SIZ 4 * 1024u
#endif
...
aw_err_t aw_shell_segger_rtt_cfg(void)
{
    ...
    ret = aw_shell_segger_rtt_init(
        &__g_shell_segger_rtt_dev, AW_CFG_SHELL_RTT_COMID, "rtt shell", &__g_shell_segger_rtt_opt);
