...
* All rights reserved.
*
* Contact information:  add Apollo platform
*
...
typedef struct aw_stat gstat_t;
#define st_mtime st_mtim.tv_sec  /* fix page.c line 79 => sbuf->mtime = s.st_mtime; */
...
void emfUnschedAllCallback( void ); // by chentan. 20160120
