...
struct awbl_hc595_digi_led_dev {
    ...
    aw_err_t (*pfn_hc595_led_set_by_digitron)(struct awbl_hc595_digi_led_dev *p_this,
    		                                  int                             id,
    		                                  bool_t                          on);

    aw_err_t (*pfn_hc595_led_toggle_by_digitron)(struct awbl_hc595_digi_led_dev *p_this,
    		                                     int                             id);

};

aw_local aw_inline aw_err_t awbl_hc595_digi_led_set (struct awbl_hc595_digi_led_dev *p_this,
                                                     int                             id,
                                                     bool_t                          on){
...
aw_local aw_inline aw_err_t awbl_hc595_digi_led_toggle (struct awbl_hc595_digi_led_dev *p_this,
                                                        int                             id){
