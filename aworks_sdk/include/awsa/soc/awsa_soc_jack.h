 ...
 * \param[in] type    : a bitmask of enum snd_jack_type values that
 ...
 * \param[in] status : a bitmask of enum snd_jack_type values
 *                     that are currently detected.
 * \param[in] mask   : a bitmask of enum snd_jack_type values
 *                     that being reported.
 *
 * \return no
...
/**
 * \brief Release GPIO pins' resources of an ASoC jack
 *
