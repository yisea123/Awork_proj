...
aw_local void __imx1050_lpuart2_plat_init (void)
{
...
//aw_local void __imx1050_lpuart2_rs485_dir (uint8_t dir)
//{
//    //aw_gpio_set(GPIO17, dir);
//}

/* imx1050 lpuart2 设备信息 */
aw_local awbl_imx1050_lpuart_dev_info_t aw_const __g_imx1050_lpuart2_devinfo = {
    INUM_LPUART2,                // irq
    IMX1050_LPUART2_BASE,        // 寄存器基地址
    IMX1050_CLK_CG_LPUART2,      // 输入时钟id
    115200,
    __imx1050_lpuart2_plat_init, // 平台初始化函数
    NULL                         // RS485方向控制函数

};

/* imx1050内部UART设备实例内存静态分配 */
aw_local struct awbl_imx1050_uart_dev __g_imx1050_lpuart2_dev;
...
#define AWBL_HWCONF_IMX1050_LPUART2     \
    {                                   \
        ...
        AWBL_BUSID_PLB,                 \
        0,                              \
        &__g_imx1050_lpuart2_dev.dev,   \
        &__g_imx1050_lpuart2_devinfo    \
    },
#else
#define AWBL_HWCONF_IMX1050_LPUART2
#endif
