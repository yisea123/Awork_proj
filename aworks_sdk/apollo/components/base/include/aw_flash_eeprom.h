...
typedef struct awbl_flash_eeprom_dev {
    struct aw_mtd_info          *p_mtd_dev;   /**< eeprom flash设备 */
    awbl_flash_eeprom_devinfo_t *p_info;      /**< eeprom flash设备配置信息 */
    int32_t                      cur_addr;    /**< 当前指向操作的flash地址  */
    uint16_t                     w_block_num; /**< 当前指向操作的flash块号  */

    AW_MUTEX_DECL(mutex);                     /**< 互斥量，保护FLASH EEPROM */
    aw_mutex_id_t mutex_id;                   /**< 互斥量id */
