 ...
 *   05. "leave" 离开已加入的热点
 *   06. "startap AWWIFI wpa2_aes meiyoumima 6" 在 6 号 频道创建名称为 AWWIFI, 密码为 meiyoumima 的热点
 *   07. "maxassoc" 获取最多可加入本地创建的热点的客户端的数量
 *   08. "getstalist" 获取已加入本地创建的热点的客户端信息
 *   09. "stopap" 关闭已创建的的热点
 *   10. "startap AWWIFI wpa2_aes meiyoumima 6 10.0.0.1/24 10.0.0.1" 创建热点并指定 IP 地址
