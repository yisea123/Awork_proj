...
#ifndef __AWBL_IMX1050_ENC_H
#define __AWBL_IMX1050_ENC_H
...
/** \brief iMX RT1050 ENC 驱动名 */
#define IMX1050_ENC_NAME            "imx1050_enc"
...
/**
 * \brief iMX RT1050 ENC 设备信息
 */
typedef struct awbl_imx1050_enc_devinfo {
...
} awbl_imx1050_enc_devinfo_t;



/**
 * \brief iMX RT1050 ENC 设备实例
 */
typedef struct awbl_imx1050_enc_dev {

    struct awbl_dev         super;       /**< \brief 继承自 AWBus 设备 */
    struct awbl_enc_service enc_serv;    /**< \brief 设备服务 */

} awbl_imx1050_enc_dev_t;

/**
 * \brief iMX RT1050 ENC 驱动注册
 */
void awbl_imx1050_enc_drv_register (void);
