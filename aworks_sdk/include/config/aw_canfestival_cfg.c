...
#define __COP_MAX_INST         1             /* 实例个数 */
#define __COP_RECV_TASK_PRIO   4             /* 接收任务优先级 */

#define __COP_TIME_NAME        "imx1050_gpt" /* 定时器名称 */
#define __COP_TIME_UNIT        1             /* 定时器UNIT */
#define __COP_TIME_ID          0             /* 定时器ID */
