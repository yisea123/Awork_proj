 ...
 * \param[in] wait_type     事件组节点等待方式，AW_FLAG_NODE_WAIT_AND 或 AW_FLAG_NODE_WAIT_OR
 *                      若等待条件后需要清除该标志位，可以|AW_FLAG_NODE_WAIT_CLEAR，如：
 *                      (AW_FLAG_NODE_WAIT_AND|AW_FLAG_NODE_WAIT_CLEAR)，
 *                      (AW_FLAG_NODE_WAIT_OR|AW_FLAG_NODE_WAIT_CLEAR)，
 ...
 * \param[in] option        设置方式： AW_FLAG_OPT_SET、AW_FLAG_OPT_CLR、AW_FLAG_OPT_CPY，如：
