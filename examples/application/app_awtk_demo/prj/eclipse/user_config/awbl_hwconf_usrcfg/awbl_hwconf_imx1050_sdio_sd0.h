...
#include "driver/sdio/awbl_imx1050_sdio.h"
...
/* 检测卡插拔状态 */
aw_local bool_t __imx1050_sdio_ssp0_detect (awbl_imx1050_sdio_dev_t *p_dev)
{
    return (aw_gpio_get(GPIO2_28) ? FALSE : TRUE);
}

/* 设备信息 */
aw_local aw_const awbl_imx1050_sdio_dev_info_t __g_imx1050_sdio_ssp0_devinfo = {
    {
        0,
        AWBL_SDIO_SD_4B_M,
...
/* 设备实例内存静态分配 */
awbl_imx1050_sdio_dev_t __g_imx1050_sdio_ssp0_dev;

#define AWBL_HWCONF_IMX1050_SDIO_SSP0                    \
    {                                                    \
        AWBL_IMX1050_SDIO_NAME,                          \
        0,                                               \
        AWBL_BUSID_PLB,                                  \
        0,                                               \
