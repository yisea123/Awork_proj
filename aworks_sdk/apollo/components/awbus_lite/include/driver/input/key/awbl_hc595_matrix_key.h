...
struct awbl_hc595_matrix_key_dev {
	 ...
	 * \brief 按键检测
	 */
	void (*pfn_hc595_key_detect)(struct awbl_hc595_matrix_key_dev *p_this, uint8_t idx);

};


aw_local aw_inline void awbl_hc595_matrix_key_detect(struct awbl_hc595_matrix_key_dev *p_this,
		                                             uint8_t                           idx)
{
