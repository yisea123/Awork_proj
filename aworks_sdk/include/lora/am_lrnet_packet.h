...
#define AM_LRNET_PACKET_WAKEUP_PL_SIZE       3   /**< \brief wakeup packet payload size */
#define AM_LRNET_PACKET_TYPICAL_PL_SIZE      16  /**< \brief typical packet payload size */

#define AM_LRNET_PACKET_MSGTYPE_NORMAL       0u  /**< \brief packet msgtype: normal */
#define AM_LRNET_PACKET_MSGTYPE_MULTIHOP     1u  /**< \brief packet msgtype: multi-hop */
#define AM_LRNET_PACKET_MSGTYPE_WAKEUP       2u  /**< \brief packet msgtype: wakeup */
#define AM_LRNET_PACKET_MSGTYPE_ACK          3u  /**< \brief packet msgtype: ack */
...
am_lrnet_packet_t* am_lrnet_packet_multihop_init (am_lrnet_multihop_info_t *p_multi);
am_lrnet_packet_t* am_lrnet_packet_ack_init (const am_lrnet_packet_t *p_rx_packet);
am_lrnet_packet_t* am_lrnet_packet_wakeup_init (uint16_t tar_addr,
                                                uint8_t  data_size,
                                                uint16_t leave_ms);
am_lrnet_packet_t* am_lrnet_packet_reply_init (const am_lrnet_packet_t *p_packet_rx);
