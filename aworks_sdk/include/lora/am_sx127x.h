...
void am_sx127x_rx_config_set (am_sx127x_handle_t handle,
                              am_lora_radio_modems_t modem, uint32_t bandwidth,
                              uint32_t datarate,      uint8_t  coderate,
                              uint32_t bandwidth_afc, uint16_t preamble_len,
                              uint16_t symb_timeout,  uint8_t  fix_len,
                              uint8_t  payload_len,
                              uint8_t  crc_on,        uint8_t  freq_hop_on, uint8_t hop_period,
                              uint8_t  iq_inverted,   uint8_t  rx_continuous);
...
void am_sx127x_tx_config_set (am_sx127x_handle_t handle,
                              am_lora_radio_modems_t modem, int8_t power, uint32_t freq_dev,
                              uint32_t bandwidth,  uint32_t datarate,
                              uint8_t  coderate,   uint16_t preamble_len,
                              uint8_t  fix_len,    uint8_t  crc_on,      uint8_t  freq_hop_on,
                              uint8_t  hop_period, uint8_t  iq_inverted, uint32_t timeout);
 ...
 *
 * \Remark 只能在am_lora_am_sx127x_rx_config_set 或 am_lora_am_sx127x_tx_config_set被调用后调用一次。
 *
 * \param[in] handle  : SX1276 服务操作句柄
 * \param[in] modem   : 使用的射频模式 [0: FSK, 1: LoRa]
 * \param[in] pkt_len : 负载包长度
