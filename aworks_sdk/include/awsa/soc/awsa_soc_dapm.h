...
struct awsa_soc_dapm_widget {
    ...
    bool_t    new;             /**< \brief cnew complete */
    bool_t    connected;       /**< \brief connected codec pin */
    bool_t    ext;             /**< \brief has external widgets */
    bool_t    power;           /**< \brief block power status */
    bool_t    active;          /**< \brief active stream on DAC, ADC's */
    bool_t    force;           /**< \brief force state */
    bool_t    ignore_suspend;  /**< \brief kept enabled over suspend */
...
aw_err_t awsa_soc_dapm_set_volsw (
    struct awsa_core_ctl_elem       *p_ctl_elem,
    struct awsa_core_ctl_elem_value *p_value);

aw_err_t awsa_soc_dapm_get_volsw (
    struct awsa_core_ctl_elem       *p_ctl_elem,
    struct awsa_core_ctl_elem_value *p_value);

aw_err_t awsa_soc_dapm_get_enum_double (
    struct awsa_core_ctl_elem       *p_ctl_elem,
    struct awsa_core_ctl_elem_value *p_value);

aw_err_t awsa_soc_dapm_set_enum_double (
    struct awsa_core_ctl_elem       *p_ctl_elem,
    struct awsa_core_ctl_elem_value *p_value);

aw_err_t awsa_soc_dapm_get_enum_virt (
    struct awsa_core_ctl_elem       *p_ctl_elem,
    struct awsa_core_ctl_elem_value *p_value);

aw_err_t awsa_soc_dapm_set_enum_virt (
    struct awsa_core_ctl_elem       *p_ctl_elem,
    struct awsa_core_ctl_elem_value *p_value);

aw_err_t awsa_soc_dapm_get_value_enum_double (
    struct awsa_core_ctl_elem       *p_ctl_elem,
    struct awsa_core_ctl_elem_value *p_value);

aw_err_t awsa_soc_dapm_set_value_enum_double (
    struct awsa_core_ctl_elem       *p_ctl_elem,
    struct awsa_core_ctl_elem_value *p_value);

aw_err_t awsa_soc_dapm_info_pin_switch (
    struct awsa_core_ctl_elem      *p_ctl_elem,
    struct awsa_core_ctl_elem_info *p_info);

aw_err_t awsa_soc_dapm_get_pin_switch (
    struct awsa_core_ctl_elem       *p_ctl_elem,
    struct awsa_core_ctl_elem_value *p_value);

aw_err_t awsa_soc_dapm_set_pin_switch (
    struct awsa_core_ctl_elem       *p_ctl_elem,
    struct awsa_core_ctl_elem_value *p_value);

aw_err_t awsa_soc_dapm_new_ctl (
    struct awsa_soc_dapm_context      *p_dapm,
    const struct awsa_soc_dapm_widget *p_widget);

aw_err_t awsa_soc_dapm_new_ctls (
    struct awsa_soc_dapm_context      *p_dapm,
    const struct awsa_soc_dapm_widget *p_widget,
    int                                num);
