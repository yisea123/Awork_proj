...
struct dc_buzzer {
    struct awbl_buzzer_dev  bdev;       /**< buzzer device, should go first */
    struct awbl_dev         dev;        /**< the AWBus device */
    uint16_t                gpio;       /**< GPIO number the buzzer is driven */
    uint16_t                active_low; /**< driven polarity of the GPIO */
};
