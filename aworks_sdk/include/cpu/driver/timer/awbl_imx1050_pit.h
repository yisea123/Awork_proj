...
#ifndef __AWBL_IMX1050_PIT_H
#define __AWBL_IMX1050_PIT_H
...
#include "aw_clk.h"
#include "driver/timer/imx1050_pit_regs.h"

#define AWBL_IMX1050_PIT_DRV_NAME   "imx1050_pit"

/** \brief 设备配置信息 */
typedef struct awbl_imx1050_pit_devinfo {
...
} awbl_imx1050_pit_devinfo_t;

/** \brief 设备实例 */
typedef struct awbl_imx1050_pit_dev {
...
} awbl_imx1050_pit_dev_t;

/**
 * \brief 将 IMX1050 PIT 驱动注册到 AWBus 子系统中
 *
 * \note 本函数应在 aw_prj_early_init() 中初始化，本函数中禁止调用操作系统相关函数
 */
void awbl_imx1050_pit_drv_register (void);

#ifdef __cplusplus
}
#endif

#endif /* __AWBL_IMX1050_PIT_H */
