 ...
 *
 * 本驱动实现了 lpc54xxx 24-bit The watchdog timer 的看门狗功能，提供了启动和喂狗功能
 *
 * \par 1.驱动信息
 *
 *  - 驱动名:  "lpc54xxx_wwdt"
...
struct lpc54xxx_wwdt_reg {
    ...
    uint32_t tv;          /**< \brief [0C] Watchdog timer value register.Read Only */
    uint32_t rsv;         /**< \brief [10] reserved */
    uint32_t warnint;     /**< \brief [14] Watchdog Warning Interrupt compare value */
