...
/** \brief 一般用于 logo 打印输出, 使用前需要定义 AW_VDEBUG, 若想屏蔽输出, 则只需关闭
 *         AW_VDEBUG 定义即可
 */
#ifdef AW_VDEBUG
...
/** \brief 一般用于info 打印 输出, 使用前需要定义 AW_VDEBUG_INFO, 若想屏蔽输出, 则只需关闭
 *         AW_VDEBUG_INFO 定义即可
 */
...
/** \brief 一般用于调试打印输出 , 使用前需要定义 AW_VDEBUG_DEBUG, 若想屏蔽输出, 则只需关闭
 *         AW_VDEBUG_DEBUG 定义即可
 */
...
/** \brief 一般用于警告打印输出 , 使用前需要定义 AW_VDEBUG_WARN, 若想屏蔽输出, 则只需关闭
 *         AW_VDEBUG_WARN 定义即可
 */
...
/** \brief 一般用于错误打印输出 , 使用前需要定义 AW_VDEBUG_ERROR, 若想屏蔽输出, 则只需关闭
 *         AW_VDEBUG_ERROR 定义即可
 */
