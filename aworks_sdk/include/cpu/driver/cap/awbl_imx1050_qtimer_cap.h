 ...
 * \endinternal
 */
#ifndef __AWBL_IMX1050_QTIMER_CAP_H
#define __AWBL_IMX1050_QTIMER_CAP_H
...
/* 驱动名 */
#define AWBL_IMX1050_QTIMER_CAP_NAME   "imx1050_QTimer_cap"
 ...
 */
typedef struct awbl_imx1050_qtimer_cap_devcfg {

    uint8_t              pid;          /**< \brief CAP ID */
    qtimer_channel_sel_t ch;           /**< \brief CAP对应的通道 */
    int                  gpio;         /**< \brief CAP对应的引脚 */
    uint32_t             func;         /**< \brief CAP引脚功能 */
} awbl_imx1050_qtimer_cap_devcfg_t;


/**
 * \brief iMX RT1050 QTimer CAP 设备信息
 */
typedef struct awbl_imx1050_qtimer_cap_devinfo {
    ...
    /** \brief CAP 配置信息 */
    aw_const struct awbl_imx1050_qtimer_cap_devcfg *cap_devcfg;
...
} awbl_imx1050_qtimer_cap_devinfo_t;


/**
 * \brief iMX RT1050 QTimer capture device
 */
typedef struct awbl_imx1050_qtimer_cap_dev {
...
} awbl_imx1050_qtimer_cap_dev_t;


/**
 * \brief iMX RT1050 QTimer cap driver register
 */
void awbl_imx1050_qtimer_cap_drv_register (void);
...
#endif /* __AWBL_IMX1050_QER_CAP_H */
