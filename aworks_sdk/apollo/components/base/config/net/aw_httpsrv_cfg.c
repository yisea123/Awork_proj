...
extern void httpsrv_keepalive_init(bool_t keep_switch, uint32_t overtime);
...
__HTTPSRV_TASK_DECL(http_ses,
                    ...
                    (AW_HTTPSRV_CFG_HTTP_DEFAULT_SRV_CNT * AW_HTTPSRV_CFG_HTTP_DEFAULT_SES_CNT));
#endif
...
__HTTPSRV_TASK_DECL(https_ses,
                    ...
                    (AW_HTTPSRV_CFG_HTTPS_DEFAULT_SRV_CNT * AW_HTTPSRV_CFG_HTTPS_DEFAULT_SES_CNT));
#endif
