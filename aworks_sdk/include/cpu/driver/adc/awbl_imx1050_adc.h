...
#ifndef __AWBL_IMX1050_ADC_H
#define __AWBL_IMX1050_ADC_H
...
/** \brief iMX RT1050 ADC 驱动名 */
#define IMX1050_ADC_NAME            "imx1050_adc"

/** \brief iMX RT1050 ADC 模拟输入通道范围 */
#define IMX1050_ADC_MIN_CH           0
#define IMX1050_ADC_MAX_CH           15


/**
 * \brief iMX RT1050 adc 设备信息
 */
typedef struct awbl_imx1050_adc_devinfo {
...
} awbl_imx1050_adc_devinfo_t;

/**
 * \brief iMX RT1050 adc 设备实例
 */
typedef struct awbl_imx1050_adc_dev {
...
} awbl_imx1050_adc_dev_t;

/**
 * \brief iMX RT1050 ADC 驱动注册
 */
void awbl_imx1050_adc_drv_register (void);
