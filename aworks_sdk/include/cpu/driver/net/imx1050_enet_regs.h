...
#ifndef  __IMX1050_ENET_REGS_H
#define  __IMX1050_ENET_REGS_H
...
/** @} grp_awbl_drv_imx1050_enet_hardware_struct*/

/**
 * \addtogroup grp_awbl_drv_imx1050_enet_hardware_micro ENET hardware micro
 * @{
 */

/**
 * \addtogroup grp_awbl_drv_imx1050_enet_hardware_interrupt_events ENET interrupt events flags
 * @{
 */
...
/** @} grp_awbl_drv_imx1050_enet_hardware_interrupt_events*/

/**
 * \addtogroup grp_awbl_drv_imx1050_enet_hardware_interrupt_mask ENET interrupt mask flags
 * @{
 */
...
/** @} grp_awbl_drv_imx1050_enet_hardware_interrupt_mask*/

/**
 * \addtogroup grp_awbl_drv_imx1050_enet_hardware_rx_control Receive control flags
 * @{
 */
...
/** @} grp_awbl_drv_imx1050_enet_hardware_rx_control*/


/**
 * \addtogroup grp_awbl_drv_imx1050_enet_hardware_tx_control transmit control flags
 * @{
 */
...
/** @} grp_awbl_drv_imx1050_enet_hardware_tx_control */

/**
 * \addtogroup grp_awbl_drv_imx1050_enet_hardware_enet_control enet control flags
 * @{
 */
...
/** @} grp_awbl_drv_imx1050_enet_hardware_enet_control */


/**
 * \addtogroup grp_awbl_drv_imx1050_enet_hardware_tx_fifo_watermark transmit Watermark flags
 * @{
 */
/** \brief Store And Forward Enable */
#define FEC_X_WMRK_STRFWD       0x00000100
/** @} grp_awbl_drv_imx1050_enet_hardware_tx_fifo_watermark */


/**
 * \addtogroup grp_awbl_drv_imx1050_enet_hardware_tx_rx_active_des transmit & receive active descriptor flags
 * @{
 */
...
/** @} grp_awbl_drv_imx1050_enet_hardware_tx_rx_active_des */

/**
 * \addtogroup grp_awbl_drv_imx1050_enet_hardware_mii_data MII data flags
 * @{
 */
...
/** @} grp_awbl_drv_imx1050_enet_hardware_mii_data */

/**
 * \addtogroup grp_awbl_drv_imx1050_enet_hardware_rx_des_status receive descriptor status flags
 * @{
 */
...
/** @} grp_awbl_drv_imx1050_enet_hardware_rx_des_status */

/**
 * \addtogroup grp_awbl_drv_imx1050_enet_hardware_tx_des_status transmit descriptor status flags
 * @{
 */
...
/** @} grp_awbl_drv_imx1050_enet_hardware_tx_des_status */

/**
 * \addtogroup grp_awbl_drv_imx1050_enet_hardware_others Others
 * @{
 */
...
/** @} grp_awbl_drv_imx1050_enet_hardware_others */
