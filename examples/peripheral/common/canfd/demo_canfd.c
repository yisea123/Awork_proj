 ...
 *
 * \par 源代码
 * \snippet demo_canfd.c src_fd_can
 *
 * \internal
...
static void __can_task_entry (void *p_arg)
{
    ...
    msg[0].can_msg.flags = AW_CAN_MSG_FLAG_FD_CTRL | AW_CAN_MSG_FLAG_BRS;
    msg[0].can_msg.length = 64;
#endif
