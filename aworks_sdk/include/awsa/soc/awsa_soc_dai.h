...
struct awsa_soc_dai_servopts {
     ...
     * \param[in] dir    : direction, #AW_SND_PCM_STREAM_*
     *
     ...
     *
     * \param[in] p_dai : DAI runtime data
     * \param[in] fmt   : format, #AWBL_SND_SOC_DAIFMT*
     *
     * \retval AW_OK : success
     */
...
struct awsa_soc_dai {
    ...
    bool_t                              capture_active;

    /** \brief playback stream is in use */
    bool_t                              playback_active;
