 ...
 * - 1.00 17-05-26  xdn, first implementation
 * \endinternal
 */

#ifndef __AWBL_CYW43362_DRV_COMMON_H
#define __AWBL_CYW43362_DRV_COMMON_H
...
/**
 * \addtogroup grp_awbl_cyw43362_drv_common
 * \copydoc awbl_cyw43362_drv_common.h
 * @{
 */
...
aw_err_t awbl_wiced_nic_set_link_up (awbl_dev_t *p_dev, aw_wifi_interface_t interface);

aw_err_t awbl_wiced_nic_set_link_down (awbl_dev_t *p_dev, aw_wifi_interface_t interface);
...
/** @} grp_awbl_cyw43362_drv_common */

#ifdef __cplusplus
}
#endif  /* __cplusplus */

#endif /* __AWBL_CYW43362_DRV_COMMON_H */
