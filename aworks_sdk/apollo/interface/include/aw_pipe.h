...
aw_err_t aw_pipe_read(aw_pipe_t p_pipe, void *p_buf, size_t nbytes, size_t *p_readbytes, int timeout);
 ...
 * \return 成功存放的数据个数
 */
aw_err_t aw_pipe_write(aw_pipe_t p_pipe, const void *p_buf, size_t nbytes, size_t *p_writebytes, int timeout);
