...
aw_local void __imx1050_lpuart8_plat_init (void)
{
...
//aw_local void __imx1050_lpuart8_rs485_dir (uint8_t dir)
//{
//    //aw_gpio_set(GPIO17, dir);
//}

/* imx1050 lpuart8 设备信息 */
aw_local awbl_imx1050_lpuart_dev_info_t aw_const __g_imx1050_lpuart8_devinfo = {
    INUM_LPUART8,                // irq
    IMX1050_LPUART8_BASE,        // 寄存器基地址
    IMX1050_CLK_CG_LPUART8,      // 输入时钟id
    115200,
    __imx1050_lpuart8_plat_init, // 平台初始化函数
    NULL                         // RS485方向控制函数

};

/* imx1050内部UART设备实例内存静态分配 */
aw_local struct awbl_imx1050_uart_dev __g_imx1050_lpuart8_dev;
...
#define AWBL_HWCONF_IMX1050_LPUART8     \
    {                                   \
        ...
        AWBL_BUSID_PLB,                 \
        0,                              \
        &__g_imx1050_lpuart8_dev.dev,   \
        &__g_imx1050_lpuart8_devinfo    \
    },
#else
#define AWBL_HWCONF_IMX1050_LPUART8
#endif
