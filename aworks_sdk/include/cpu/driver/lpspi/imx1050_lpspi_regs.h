...
#ifndef __IMX1050_LPSPI_REGS_H
#define __IMX1050_LPSPI_REGS_H
...
/**
 * \brief iMX RT1050 LPSPI ¼Ä´æÆ÷¿é¶¨Òå
 */
typedef struct {

    __I  uint32_t VERID;                 /**< \brief Version ID Register, offset: 0x0 */
    __I  uint32_t PARAM;                 /**< \brief Parameter Register, offset: 0x4 */
         uint8_t RESERVED_0[8];
    __IO uint32_t CR;                    /**< \brief Control Register, offset: 0x10 */
    __IO uint32_t SR;                    /**< \brief Status Register, offset: 0x14 */
    __IO uint32_t IER;                   /**< \brief Interrupt Enable Register, offset: 0x18 */
    __IO uint32_t DER;                   /**< \brief DMA Enable Register, offset: 0x1C */
    __IO uint32_t CFGR0;                 /**< \brief Configuration Register 0, offset: 0x20 */
    __IO uint32_t CFGR1;                 /**< \brief Configuration Register 1, offset: 0x24 */
         uint8_t RESERVED_1[8];
    __IO uint32_t DMR0;                  /**< \brief Data Match Register 0, offset: 0x30 */
    __IO uint32_t DMR1;                  /**< \brief Data Match Register 1, offset: 0x34 */
         uint8_t RESERVED_2[8];
    __IO uint32_t CCR;                   /**< \brief Clock Configuration Register, offset: 0x40 */
         uint8_t RESERVED_3[20];
    __IO uint32_t FCR;                   /**< \brief FIFO Control Register, offset: 0x58 */
    __I  uint32_t FSR;                   /**< \brief FIFO Status Register, offset: 0x5C */
    __IO uint32_t TCR;                   /**< \brief Transmit Command Register, offset: 0x60 */
    __O  uint32_t TDR;                   /**< \brief Transmit Data Register, offset: 0x64 */
         uint8_t RESERVED_4[8];
    __I  uint32_t RSR;                   /**< \brief Receive Status Register, offset: 0x70 */
    __I  uint32_t RDR;                   /**< \brief Receive Data Register, offset: 0x74 */

} imx1050_lpspi_regs_t;
