 ...
 *
 * \par 源代码
 * \snippet demo_vfp_swith_context.c src_vfp_swith_context
 *
 * \internal
...
/**
 * \addtogroup demo_if_vfp_swith_context
 * \copydoc demo_vfp_swith_context.c
 */

/** [src_vfp_swith_context] */
...
void demo_vfp_swith_context(void){
    ...
    aw_kprintf("task_test_ln2 task invalid.\r\n");
