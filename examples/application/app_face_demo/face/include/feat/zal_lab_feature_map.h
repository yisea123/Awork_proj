#ifndef zal_FD_FEAT_LAB_FEATURE_MAP_H_
#define zal_FD_FEAT_LAB_FEATURE_MAP_H_
...
class LABFeatureMap : public zal::fd::FeatureMap {
 public:
...
#endif  // ZAL_FD_FEAT_LAB_FEATURE_MAP_H_
