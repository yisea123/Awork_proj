...
struct awbl_digitron_common_ops {
	...
	void (*pfn_digitron_disp_blink_set)(struct awbl_digitron_dev *p_dd, int index, bool_t blink);

	void (*pfn_digitron_disp_at)(struct awbl_digitron_dev *p_dd, int index, uint16_t seg);

	void (*pfn_digitron_disp_char_at)(struct awbl_digitron_dev *p_dd, int index, const char ch);

	void (*pfn_digitron_disp_str)(struct awbl_digitron_dev *p_dd, int index, int len, const char *p_str);
