...
#define AWSA_SOC_DAPM_SINGLE(xname, xreg, xshift, xmax, xinvert) \
    AWSA_CORE_CTL_ELEM_DECL(xname,                               \
                            AWSA_CORE_CTL_ELEM_IF_MIXER,         \
                            awsa_soc_volsw_info,                 \
                            awsa_soc_dapm_get_volsw,             \
                            awsa_soc_dapm_set_volsw,             \
                            NULL,                                \
                            AWSA_SOC_SINGLE_VALUE(               \
                                xreg, xshift, xmax, xinvert))
...
#define AWSA_SOC_DAPM_ENUM(xname, xenum)                         \
    AWSA_CORE_CTL_ELEM_DECL(xname,                               \
                            AWSA_CORE_CTL_ELEM_IF_MIXER,         \
                            awsa_soc_enum_double_info,           \
                            awsa_soc_dapm_get_enum_double,       \
                            awsa_soc_dapm_set_enum_double,       \
                            NULL,                                \
                            (uint32_t)&xenum)
...
#define AWSA_SOC_DAPM_ENUM_VIRT(xname, xenum)                    \
    AWSA_CORE_CTL_ELEM_DECL(xname,                               \
                            AWSA_CORE_CTL_ELEM_IF_MIXER,         \
                            awsa_soc_enum_double_info,           \
                            awsa_soc_dapm_get_enum_virt,         \
                            awsa_soc_dapm_set_enum_virt,         \
                            NULL,                                \
                            (uint32_t)&xenum)
...
#define AWSA_SOC_DAPM_VALUE_ENUM(xname, xenum)                    \
    AWSA_CORE_CTL_ELEM_DECL(xname,                                \
                            AWSA_CORE_CTL_ELEM_IF_MIXER,          \
                            awsa_soc_enum_double_info,            \
                            awsa_soc_dapm_get_value_enum_double,  \
                            awsa_soc_dapm_set_value_enum_double,  \
                            NULL,                                 \
                            (uint32_t)&xenum)
...
#define AWSA_SOC_DAPM_PIN_SWITCH(xname)                       \
    AWSA_CORE_CTL_ELEM_DECL(xname " Switch",                  \
                            AWSA_CORE_CTL_ELEM_IF_MIXER,      \
                            awsa_soc_dapm_info_pin_switch,    \
                            awsa_soc_dapm_get_pin_switch,     \
                            awsa_soc_dapm_set_pin_switch,     \
                            NULL,                             \
                            (uint32_t)xname)
...
/**
 * \brief enum extend information get
 */
