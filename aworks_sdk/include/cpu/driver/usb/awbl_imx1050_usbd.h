...
/**
 * \file
 * \brief iMX RT1050 USB device controller driver head file
 *
 * \internal
...
#ifndef __AWBL_IMX1050_USBD_H
#define __AWBL_IMX1050_USBD_H
...
#define AWBL_IMX1050_USBD_DRV_NAME    "awbl_imx1050_usbd"

#define  __USB_DEVICE_TASK_STACK_SIZE     1024


/** \brief imx1050 USB device EndPoint Queue Head (dQH) */
struct awbl_imx1050_usbd_qh {
    uint32_t    info1;
...
/** \brief imx1050 USB device transfer descriptor (dDT) */
struct awbl_imx1050_usbd_td {
    uint32_t                    next;
...
struct awbl_imx1050_usbd_ep {
    struct awbl_usbd_ep         ep;
    struct awbl_imx1050_usbd      *p_usbd;
    struct awbl_imx1050_usbd_qh   *p_qh;
...
/** \brief imx1050 USB device controller struct */
struct awbl_imx1050_usbd {
    struct awbl_usbd            usbd;

    /** \brief EPs (IN and OUT) */
    struct awbl_imx1050_usbd_ep   *eps;
    struct awbl_imx1050_usbd_qh   *qhs;
...
/** \brief imx1050 USB device controller information */
struct awbl_imx1050_usbd_info {
...
void awbl_imx1050_usbd_drv_register (void);

#ifdef __cplusplus
}
#endif  /* __cplusplus  */

#endif /* __AWBL_IMX1050_USBD_H */
