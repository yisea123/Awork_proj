...
def genString(tool_path, src_dir, dst_dir):
...
def genFont(tool_path, src_dir, dst_dir):
...
def genImage(tool_path, src_dir, dst_dir, dpi): 
...
def genUI(tool_path, src_dir, dst_dir): 
...
if len(sys.argv) <= 3 :
  print('assets_gen.py tools_dir src_dir dst_dir')
  exit()
