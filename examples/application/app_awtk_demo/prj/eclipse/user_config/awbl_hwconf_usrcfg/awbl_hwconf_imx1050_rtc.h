...
#include "driver/rtc/awbl_imx1050_rtc.h"
...
aw_local aw_const struct awbl_imx1050_rtc_devinfo  __g_imx1050_rtc_devinfo = {
    {
...
/* 设备实例内存静态分配 */
aw_local struct awbl_imx1050_rtc_dev __g_imx1050_rtc_dev;

#define AWBL_HWCONF_IMX1050_RTC   \
{                                 \
    AWBL_IMX1050_RTC_NAME,        \
    0,                            \
    AWBL_BUSID_PLB,               \
    0,                            \
