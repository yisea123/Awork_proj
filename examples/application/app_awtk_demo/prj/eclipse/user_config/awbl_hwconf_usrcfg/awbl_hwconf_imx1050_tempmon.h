...
/* 设备信息 */
aw_local aw_const struct awbl_imx1050_tempmon_devinfo __g_imx1050_tempmon_devinfo = {
...
/* 设备实例内存静态分配 */
aw_local struct awbl_imx1050_tempmon_dev __g_imx1050_tempmon_dev;

#define AWBL_HWCONF_IMX1050_TEMPMON                  \
    {                                                \
        AWBL_IMX1050_TEMPMON_NAME,                   \
        0,                                           \
        AWBL_BUSID_PLB,                              \
        0,                                           \
