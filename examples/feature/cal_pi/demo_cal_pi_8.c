 ...
 *
 * \par 源代码
 * \snippet demo_cal_pi_8.c src_cal_pi_8
 *
 * \internal
...
/**
 * \addtogroup demo_if_cal_pi_8
 * \copydoc demo_cal_pi_8.c
 */
...
static double __cal_pi_8(int cal_count)
{
    const int       split = 8;
