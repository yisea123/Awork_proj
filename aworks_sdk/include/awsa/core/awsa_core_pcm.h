 ...
 */
struct awsa_core_pcm_hardware {
    uint64_t           formats;            /**< \brief AWBL_SND_PCM_FMTBIT_* */
    uint32_t           rates;              /**< \brief AWBL_SND_PCM_RATE_* */
 ...
 * \param[in] dir    : playback(#AW_SND_PCM_STREAM_PLAYBACK) or
 *                     capture(#AW_SND_PCM_STREAM_CAPTURE)
 ...
 */
static inline
bool_t awsa_core_pcm_is_running (struct awsa_core_pcm_substream *p_substream)
{
