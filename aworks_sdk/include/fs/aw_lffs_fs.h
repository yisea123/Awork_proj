...
struct aw_lffs_object {
    ...
    struct aw_lffs_device *dev;                   //!< lffs device
    uint32_t     oflag;
    uint8_t      type;
    ...
    /******* init level 1 ********/
    struct aw_lffs_tree_node *node;                     //!< file entry node in tree
    uint16_t                  serial;
    ...
    /***** others *******/
    bool_t attr_loaded;                  //!< attributes loaded ?
    bool_t open_succ;                    //!< U_TRUE or U_FALSE
...
aw_err_t aw_lffs_object_create_ex (aw_lffs_object_t *obj, struct aw_lffs_device *dev,
                                   int dir, const char *name, int name_len, int oflag);
aw_err_t aw_lffs_object_open_ex (aw_lffs_object_t *obj, struct aw_lffs_device *dev,
                                   int dir, const char *name, int name_len, int oflag);

aw_err_t aw_lffs_object_open (aw_lffs_object_t *obj, const char *fullname, int oflag);
aw_err_t aw_lffs_object_truncate (aw_lffs_object_t *obj, uint32_t remain);
aw_err_t aw_lffs_object_create (aw_lffs_object_t *obj, const char *fullname, int oflag);
...
aw_err_t aw_lffs_object_rename (const char *old_name, const char *new_name, int *err);
