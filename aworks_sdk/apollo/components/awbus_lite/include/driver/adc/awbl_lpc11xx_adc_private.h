...
#define __CH_SETS(base,chs)       AW_REG_BITS_SET32((base) + __CR, __CH_BIT_START, __CH_BIT_LEN, (chs))

#define __DIV_BIT_START           8
#define __DIV_BIT_LEN             8
#define __CLK_DIV_SET(base, div)  AW_REG_BITS_SET32((base) + __CR, __DIV_BIT_START, __DIV_BIT_LEN, (div))
#define __CLK_DIV_GET(base)       AW_REG_BITS_GET32((base) + __CR, __DIV_BIT_START, __DIV_BIT_LEN)
...
#define __CLKS_SET(base, clks)    AW_REG_BITS_SET32((base) + __CR, __CLKS_BIT_START, __CLKS_BIT_LEN, (clks))
#define __CLKS_GET(base)          AW_REG_BITS_GET32((base) + __CR, __CLKS_BIT_START, __CLKS_BIT_LEN)
...
#define __START_MODE(base, mode)  AW_REG_BITS_SET32((base) + __CR, __START_BIT_START, __START_BIT_LEN, (mode))
