 ...
 *        -AW_ENODEV    设备不存在
 */
aw_err_t aw_wifi_config_apply (aw_wifi_id_t id, bool_t force);
/**
 * \brief 获取运行状态
 * \param id            设备 ID
 * \param p_status      运行状态
 ...
 * \param id            设备 ID
 * \param is_joined     已加入输出 TRUE
 *
 * \return AW_OK        操作成功
 *        -AW_ENODEV    设备不存在
 */
aw_err_t aw_wifi_is_sta_joined (aw_wifi_id_t id, bool_t *is_joined);
/**
 * \brief 离开无线网络
 * \param id            设备 ID
 *
 ...
 * \brief 查询 AP 是否已经启动
 * \param id            设备 ID
 * \param is_on         已启动输出 TRUE
 *
 * \return AW_OK        操作成功
 *        -AW_ENODEV    设备不存在
 *        -AW_ENOTSUP   设备不支持 AP 功能
 */
aw_err_t aw_wifi_is_ap_on (aw_wifi_id_t id, bool_t *is_on);
/**
 * \brief 关闭热点
 * \param id            设备 ID
 *
