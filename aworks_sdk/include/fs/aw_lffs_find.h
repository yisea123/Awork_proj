...
aw_err_t aw_lffs_object_info_get (aw_lffs_object_t *obj, aw_lffs_object_info_t *info, int *err);
aw_err_t aw_lffs_findinfo_open (aw_lffs_findinfo_t *find_handle, aw_lffs_object_t *dir);
aw_err_t aw_lffs_findinfo_open_ex (aw_lffs_findinfo_t *f, aw_lffs_device_t *dev, int dir);
aw_err_t aw_lffs_first_object_info_find (aw_lffs_object_info_t *info, aw_lffs_findinfo_t *find_handle);
aw_err_t aw_lffs_next_object_info_find (aw_lffs_object_info_t *info, aw_lffs_findinfo_t *find_handle);
