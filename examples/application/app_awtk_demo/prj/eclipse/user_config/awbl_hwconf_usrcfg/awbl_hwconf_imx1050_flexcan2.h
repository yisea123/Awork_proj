...
#include "driver/can/awbl_imx1050_can.h"
...
/** \brief CAN2 设备信息 */
aw_local aw_const struct awbl_imx1050_can_dev_info __g_imx1050_can2_devinfo = {
    {
...
aw_local struct awbl_imx1050_can_dev __g_imx1050_can2_dev;

#define AWBL_HWCONF_IMX1050_CAN2     \
    {                                \
        AWBL_IMX1050_CAN_NAME,       \
        2,                           \
        AWBL_BUSID_PLB,              \
        0,                           \
